  ...
  const renderNav = (isMobile: boolean) => {
    ...
    return (
      ...
      >
        ...
        <ul className="flex-1 min-h-0 space-y-1 overflow-y-auto pr-0.5 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-border/60 [scrollbar-width:thin]">
          {visibleGroups.map((g) => {
