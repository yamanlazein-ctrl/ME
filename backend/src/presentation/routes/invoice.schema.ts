...
export const createInvoiceSchema = z.object({
  ...
  discount: z.number().int().min(0, "الخصم لا يمكن أن يكون سالباً").optional(),
  tax: z.number().int().min(0, "الضريبة لا يمكن أن تكون سالبة").optional(),
  shipping: z.number().int().min(0, "الشحن لا يمكن أن يكون سالباً").optional(),
